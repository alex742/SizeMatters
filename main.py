...
# input_text_file = "data/testOutputRE.txt"
...
# getLabelledFeatures("tests/nextqq1589304018/labelled_sentences_extra.txt", "tests/nextqq1589304018/labelled_features.txt")
